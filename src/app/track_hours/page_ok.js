...
export default function TrackHours() {
  ...
  useEffect(() => {
    ...
    setWeekOf(`Week of ${shortMonths[monday.getMonth()]} ${monday.getDate()}, ${monday.getFullYear()}`);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="bg-[#f14b0e] text-white p-4 flex justify-between items-center">
        ...
        <Image
          src="data:image/svg+xml;base64,"
          alt="Menu"
          width={24}
          height={24}
        />
      ...
      <div className="flex-grow p-4" role="main">
        ...
        <h3 id="weekOf" className="text-[#181311] text-[22px] font-bold leading-tight tracking-[-0.015em] pb-3 pt-5">
          {weekOf}
        </h3>
